exports.getpId = (req, res, next, pId) => {
...
exports.trails = (req, res) => {
  return res.json("yes this is working in trails");
};

exports.submain = (req, res) => {
  ...
  time()
    .then((d) => {
      ...
      let plId = req.pId;
      return res.status(200).json({ pId, details });
    })
    .catch((err) => console.log(err));
};
